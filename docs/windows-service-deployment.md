...
- Wrapper 配置：`C:\Users\YOUR_USERNAME\.wechat-codex\windows-service\wechat-codex-service.xml`
- Wrapper 日志：`C:\Users\YOUR_USERNAME\.wechat-codex\windows-service\logs\`
- 主 bridge 日志：`C:\Users\YOUR_USERNAME\.wechat-codex\logs\service.stdout.log`
- 主 bridge 错误日志：`C:\Users\YOUR_USERNAME\.wechat-codex\logs\service.stderr.log`
...
<arguments>"C:\path\to\wechat-codex\dist\main.js" start</arguments>
<workingdirectory>C:\path\to\wechat-codex</workingdirectory>
<logpath>C:\Users\YOUR_USERNAME\.wechat-codex\windows-service\logs</logpath>
<env name="WCC_DATA_DIR" value="C:\Users\YOUR_USERNAME\.wechat-codex" />
<env name="CODEX_HOME" value="C:\Users\YOUR_USERNAME\.codex" />
...
- 模型：`gpt-5.4`
- 推理强度：`medium`
- Codex 路径：`C:\Users\YOUR_USERNAME\.codex\.sandbox-bin\codex.exe`
