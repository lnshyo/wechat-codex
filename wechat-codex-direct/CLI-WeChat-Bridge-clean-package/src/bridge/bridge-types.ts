...
export type BridgeSendInputOptions = {
...
export type BridgeState = {
  forwardedTurnEvents?: Array<{
    context: "final_reply" | "mirrored_user_input";
    turnId: string;
    sentAt: string;
  }>;
  instanceId: string;
...
export interface BridgeAdapter {
  ...
  start(): Promise<void>;
  sendInput(text: string, options?: BridgeSendInputOptions): Promise<void>;
  setPinnedSession?(sessionId: string | null): Promise<void> | void;
