...
function Get-ManagedConfig {
  ...
  $repoPath = "C:\Users\YOUR_USERNAME\Desktop\CLI-WeChat-Bridge_repo"
  $workspaceRealPath = [System.IO.Path]::GetFullPath((Join-Path $repoRealPath "..\.."))
  $workspaceAliasPath = "C:\Users\YOUR_USERNAME\Desktop\AGTK_workdir"
  $codexCommand = "C:\Users\YOUR_USERNAME\.codex\.sandbox-bin\codex.exe"
